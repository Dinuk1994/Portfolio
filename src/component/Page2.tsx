        ...
        <div>
            <div className='bg-bg-color shadow-[inset_0_30px_35px_0px_rgba(0,0,0,0.2)]  p-10 tablet-or-mobile:p-2'>
                <div className='mt-10 ml-20 tablet-or-mobile:ml-2 tablet-or-mobile:mt-4'>
                    ...
                    <div data-aos="fade-up" className='mt-10 tablet-or-mobile:mt-6 mb-10'>
                        ...
                        <div data-aos-anchor-placement="center-bottom" className='grid grid-cols-5 gap-y-9 tablet-or-mobile:grid-cols-3 mt-5'>
